...
def main():
    ...
    cb_lop.current(0)
    cb_lop.place(x=580,y=169)
    Frame(bg,width=287,height=5,bg= "white").place(x=560,y=169)
    Frame(bg,width=276,height=5,bg= "white").place(x=570,y=190)
    Frame(bg,width=5,height=20,bg= "white").place(x=578,y=172)

    txt_masv=Entry(bg,width=30,bd=0,font=("Baloo Tamma",12))
    txt_masv.place(x=580,y=235)

    txt_hoten=Entry(bg,width=30,bd=0,font=("Baloo Tamma",12))
    txt_hoten.place(x=580,y=298)


    txt_tenmahoa=Entry(bg,width=30,bd=0,font=("Baloo Tamma",12))
    txt_tenmahoa.place(x=580,y=363)
